...
def find_and_draw_differences(img1_path, img2_path):
    ...
    plt.axis('off')
    plt.savefig('../output_image/matched_3.jpg')

    # Unmatched keypoints
    img1_with_unmatched = draw_keypoints(img1, unmatched_kp1, color=(0, 0, 255))
    ...
    plt.axis('off')
    plt.savefig('../output_image/unmatched_3.jpg')

    plt.show()


# Example usage
find_and_draw_differences('../screenshots/ss_1.png',
